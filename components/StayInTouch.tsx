...
import {BsFacebook, BsInstagram, BsPinterest, BsVimeo, BsX, BsYoutube} from "react-icons/bs";
	...
	return (
		<main>
			...
			<div className="grid grid-cols-1 grid-rows-6 w-full gap-3">
				...
				<span className="flex w-full items-center justify-start gap-3 bg-black mx-auto px-3 py-2 font-medium text-white rounded-md shadow-lg shadow-black/50"><BsX /> <h2>X</h2></span>
