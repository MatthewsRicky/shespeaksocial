...
const Blog = () => {
	return (
		<main className="relative flex items-start gap-6 justify-center lg:w-[85%]">
      <section className="md:w-[70%] lg:w-[65%] grid md:grid-cols-2 gap-4 items-center justify-center mt-48 lg:my-32">
	      {posts.map((post) => (
		      <div key={post.id} className="relative bg-white shadow-md shadow-slate-800 flex flex-col items-center justify-between h-[85%] w-[90%] text-start mx-auto rounded-md gap-4">
			      ...
			      <div className="flex flex-col items-start justify-start gap-4 p-1 text-sm">
