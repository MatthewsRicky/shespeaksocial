...
const Blog = () => {
	return (
		<main className="relative flex items-start gap-8 justify-center lg:w-[95%]">
      <section className="md:w-[70%] lg:w-[65%] grid md:grid-cols-2 gap-8 items-center justify-center mt-48 lg:my-32">
	      {posts.map((post) => (
		      <div key={post.id} className="relative bg-white shadow-md shadow-slate-800 flex flex-col items-center justify-between h-full w-[95%] text-start mx-auto rounded-md gap-4">
