...
const Blog = () => {
	return (
      ...
      <section className="md:w-[70%] lg:w-[65%] grid md:grid-cols-2 gap-8 items-center justify-center mt-48 lg:my-32">
	      {posts.map((post) => (
		      <div key={post.id} className="relative bg-gradient-to-b from-pink-50 to-violet-100 shadow-md shadow-violet-300 flex flex-col items-center justify-between h-full w-[95%] text-start mx-auto rounded-md gap-4">
