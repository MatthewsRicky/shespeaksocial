		...
		<div className="flex items-center justify-center scroll-auto max-w-fit h-fit bg-gradient-to-br from-pink-50/90 to-purple-100/70 flex-col py-10">
			<header>
				...
				<div className="flex flex-col md:flex-row items-center justify-between px-4 py-3 m-w-[90%] lg:w-[80%] mx-auto rounded-lg  m-4 text-slate-900">
					<div className="flex sm:flex-col items-center justify-center text-center h-[23%] w-[90%] md:w-[23%] lg:w-[20%] rounded-lg  min-h-[28rem] py-4 px-2 m-2 sm:m-3 lg:m-4 bg-gradient-to-b from-purple-50 to-pink-100 md:translate-y-[18px] shadow-emerald-600/20 shadow-xl hover:scale-105 transition all">
