...
const reviews = [
	...
	return (
		<div className="grid grid-cols-3 gap-2 rounded-xl m-6 p-2">
			{reviews.map(item => (
				<div key={item.name} className="flex flex-col gap-6 items-center justify-between text-center text-pink-900 bg-gradient-to-b from-pink-50  to-pink-100 rounded-xl shadow-lg shadow-violet-300">
