	...
	return (
		<div className="m-4 w-full grid grid-cols-1 md:grid-cols-2 md:w-[80%] justify-center items-center rounded-lg gap-12">
			{businessCard.map((item) => (
				<div key={item.id} className="flex rounded-xl lg:h-fit text-center shadow-violet-400/50 shadow-lg gap-6 flex-col justify-center items-center overflow-none bg-linear-to-b from-violet-50 to-pink-100 h-full w-[80%] mx-auto">
